...
/**
 * deploy to Fuji command:
 * npx hardhat run scripts/layer-zero-scripts/deployLayerZero.ts --network fuji
 *
 * deploy to Goerli command:
...
const main = async (): Promise<any> => {
    ...
    // Goerli (Ethereum Testnet) & destination chain id (Fuji)
